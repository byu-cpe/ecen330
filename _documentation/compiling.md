...
You can always follow the same steps to compile your labs.  Running this build process will always compile all of your lab programs.
  ...
  * Run CMake, and point it to the directory where the primary [CMakeLists.txt]({{site.github.fileurl}}/CMakeLists.txt) file is located.  CMake will read this file and create a *Makefile* that can be used to compile your programs. 
