...
1. **Building the code:** This lab you will only write driver code.  The test application code is provided to you.
    * **Driver:** 
        ...
        * Uncomment the two lines in the *drivers* [CMakeLists.txt]({{iste.github.fileurl}}/drivers/CMakeLists.txt) file so that the *intervalTimer* library is built.  

    * **Application Code:**
        * The application code, which will test your interval timer driver, is provided to you as [main.c]({{iste.github.fileurl}}/lab3_timer/main.c) in the *lab3* directory.  
        * A [CMakeLists.txt]({{iste.github.fileurl}}/lab3_timer/CMakeLists.txt) file is also provided.
...
### Files
  ...
  - You are provided [intervalTimer.h]({{iste.github.fileurl}}/drivers/intervalTimer.h). This file is not submitted, so you should not change it.
